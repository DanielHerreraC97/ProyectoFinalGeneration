...
public class DicePlacement : MonoBehaviour
{
    ...
    {
        // Obt�n la posici�n del enemigo
        Vector3 enemyPosition = transform.position;
        // Ajusta la posici�n del dado por encima del enemigo con el desplazamiento vertical
        Vector3 dicePosition = new Vector3(enemyPosition.x, enemyPosition.y + offsetY, enemyPosition.z);
        // Crea un objeto vac�o para contener el sprite del dado en la escena
        ...
        // Crea un nuevo componente SpriteRenderer en el objeto vac�o y asigna el sprite del dado
