...
public class Sing : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        float upperLimit = originalY + moveRange; // L�mite superior del rango de movimiento
        float lowerLimit = originalY - moveRange; // L�mite inferior del rango de movimiento
